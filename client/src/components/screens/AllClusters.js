                        ...
                        data.map(item => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <button class="btn waves-effect waves-light green" onClick={() => download(item.nickname)}>
                                        Config file (.yaml)
                                    ...
                                    <Link to="/clusterinfo" state={{
                                        ...
                                        <button class="btn waves-effect waves-light green">View Full Details</button>
                                    </Link>
                                </CollapsibleItem>
