                                                ...
                                                item.State === "running" ?
                                                    (<div><p id='white-text'>
                                                        ...
                                                        <p id='white-text'>Name: <b style={{ color: 'rgb(32,151,207)' }}> {item.Names}</b></p></div>) : (<div><p id='white-text'>
                                                            Type:<b style={{ color: 'red' }}> Container</b>
                                                        </p>
                                                            <p id='white-text'>Name: <b style={{ color: 'red' }}> {item.Names}</b></p></div>)
                                            }
                                            {
                                                item.State === 'running' ?
                                                    (<div>
                                                    ...
                                                    : (<div>
                                                        ...
                                                        <p id='white-text'>ID: <b style={{ color: 'red' }}> {item.Id}</b></p>
                                                        <p id='white-text'>Image: <b style={{ color: 'red' }}>{item.Image}</b></p>
                                                    </div>)
                                            }
...

                                        {
                                            item.State === 'running' ?
                                                (<div class="card-action">
                                                    ...
                                                    <Link to="/containerdata" style={{ color: 'red' }}
                                                        state={{
                                                            idContainer: item.Id,
                                                            domainName: domainName,
                                                            nickname: nickname
